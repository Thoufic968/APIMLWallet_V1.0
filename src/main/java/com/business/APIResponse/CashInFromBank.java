...
public class CashInFromBank {
    ...
    public static ValidatableResponse cashInFromBank(Object[][] data){

        try{

            String url = MLWallet_BaseURL.adminBaseURL.concat(MLWallet_Endpoints.cashInFromBankEndPoint);
            logger.info("Url :" + url);
            ...
            DemoExcel(filePath,"CashInFromBank",transactionId,1,2);
            ...
            req_body.put("bankAccount", (String) data[0][4]);
            req_body.put("firstName", (String) data[0][5]);
            req_body.put("middleName", (String) data[0][6]);
            req_body.put("lastName", (String) data[0][7]);
            req_body.put("phoneNo", (String) data[0][8]);
            req_body.put("procId", (String) data[0][9]);
            req_body.put("shortName", (String) data[0][10]);
            req_body.put("longName", (String) data[0][11]);
            req_body.put("amount", (String) data[0][12]);
            req_body.put("currency", (String) data[0][13]);
            req_body.put("email", (String) data[0][14]);
            req_body.put("description", (String) data[0][15]);
