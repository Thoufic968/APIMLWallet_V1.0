...
import static com.utility.Utilities.getTodaysDate;
...
public class CashOutToBank {
    ...
    public static ValidatableResponse cashOutToBank(Object[][] data){
        ...
        try{
            ...
            DemoExcel(filePath,"CashoutToBank",sDate,1,13);
...
//            req_body.put("runDate", "2023-12-12");
    ...
    public static ValidatableResponse cashOutToBankWithInvalidId(Object[][] data,String id){
        try{
            String url = MLWallet_BaseURL.adminBaseURL.concat(MLWallet_Endpoints.cashOutToBankEndPoint);
            logger.info("Url :" + url);
