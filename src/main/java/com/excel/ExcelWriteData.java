...
//	}		
	...
	public static void DemoExcel_Boolean(String xlsPath,String sSheetName ,Boolean sData,int nRow,int nCell) throws IOException {
	...
	public static void DemoExcelLong(String xlsPath,String sSheetName ,Long sData,int nRow,int nCell) throws IOException {
