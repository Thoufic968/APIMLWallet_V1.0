...
//	public static synchronized void extentGetResult(ITestResult result, String details) throws Exception {
//		getResult(result, details);
//		//ExcelUpdate.writeData(details, "Pass", "");
//	}
//
//	
//	 public static void getResult(ITestResult result, String details) throws Exception {
//	        if (result.getStatus() == ITestResult.FAILURE) {
//	            
//	           if(result.wasRetried()){
//               extentLoggerFail(details);
//	           }else {
//	               //Do your operation
//	           }
